    ...
    <div className=''>
      <div className='section1 flex bg-gradient-to-r from-[#023957] to-[#056088] items-center h-[100vhs] flex-col-reverse lg:flex-row relative'>
        <div className='lg:relative 2xl:w-[50%] lg:left-[10%] lg:top-[50px] 2xl:left-[15%]' style={{zIndex:"2"}}>
          <h1 className='text-white text-[24px] font-bold sm:text-center lg:text-start lg:text-[32px] 2xl:text-[52px] 2xl:w-[100%] 2xl:m-auto'>
            {t("section1.h1")}
          </h1>
          <p className='text-white text-[18px] sm:text-center lg:text-start 2xl:m-auto 2xl:text-[24] 2xl:w-[100%]'>
            {t("section1.p")}
          </p>
      ...
      <div className='section2 m:py-[100px] xl:py-[300px]'>
        <div className='flex flex-col items-center md:flex-row md:justify-around md:items-center'>
          ...
          <div className='text-center dark:text-white md:w-[45%] md:text-start xl:flex xl:flex-col xl:items-start xl:gap-[px]' data-aos="fade-left">
            <h1 className='font-bold lg:text-[32px] xl:text-[52px]'>{t("section2.h1")}</h1>
            <p className='py-[20px] md:py-0 lg:text-[20px] lg:py-2 xl:text-[24px] xl:w-[70%]'>
             {t("section2.p")}
            </p>
            <p className='xl:text-[32px]'>{t("section2.p2")}</p>
            <ul className='flex justify-between py-[20px] md:py-0 lg:py-2 xl:gap-[20px] xl:text-[24px] text-[#056088] font-bold'>
              <li>{t("section2.l1")}</li>
              <li>{t("section2.l2")}</li>
              <li>{t("section2.l3")}</li>
            </ul>
      ...
      <div className='section3 py-[100px]'>
        <h1 className='text-center text-[32px] lg:text-[52px] font-bold text-[#056088]'>{t("section3.h1")}</h1>
        <p className='text-center text-[18px] py-5 lg:text-[32px] lg:w-[50%] lg:m-auto dark:text-[white]'>
          {t("section3.p")}
        </p>
      ...
      <div className='section4'>
        <h1 className='text-center text-[32px] lg:text-[52px] font-bold text-[#056088]'>{t("section4.h1")}</h1>
        <p className='dark:text-white text-center text-[18px] py-5 lg:text-[32px] lg:w-[50%] lg:m-auto'>
        {t("section4.p")}
        </p>
      ...
      <div className='section5' style={{backgroundImage:`url(${homeS4Bg})`}}>
        <h1 className='text-center text-[32px] lg:text-[52px] font-bold text-white'>{t("section5.h1")}</h1>
        ...
        <div className='lg:flex lg:justify-center items-center py-[100px]'>
          <div className='bg-white  p-8'>
            <h1 className='text-[32px]'>{t("section5.h1_2")}</h1>
            <p className='text-[24px] py-8'>{t("section5.p_2")}</p>
      ...
      <div className='section6'>
        <div className='flex text-[48px] justify-around flex-wrap py-[50px] dark:text-white'>
          <h1>Our Partners</h1>
          <h1>J.consttruct</h1>
          <h1>Arch</h1>
          <h1>Whix.co</h1>
      ...
      <div className='py-[100px] relative flex items-center justify-center'>
          <img src={homeS6img} alt=""  className='lg:w-[80%] m:w-[100%] m-auto ' />
      ...
      <div className='py-[100px]'>
        <div className='Email p-10' style={{backgroundImage:`url(${emailBg})`} }>
            <h1 className='text-center py-4 lg:text-[48px] text-white '>{t("section7.h1")}</h1>
            <p className='text-center py-4 text-white lg:text-[24px]'>{t("section7.p")}</p>
